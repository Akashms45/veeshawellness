...
export default function CenteredCardAnimation(props: Partial<CardAnimationProps>) {
  ...
  const allProps: CardAnimationProps = {
    ...
    bodyText:        props.bodyText        ?? "Established in 2007 under the visionary leadership of Managing Partner Hari Shankaara Nayak, VWPL Pharma has emerged as a leading pharmaceutical conglomerate. With a strong focus on innovation, quality, and customer satisfaction, we have set new benchmarks in the industry as a trusted manufacturer, exporter, and government tenderer, operating four manufacturing units with EU-GMP and PIC/S certifications.",
    bodyText2:       props.bodyText2       ?? "We envision global pharmaceutical leadership through innovation, creativity, and an unwavering commitment to enhancing patient lives. Our focus on science and medicine enables us to develop superior, differentiated products that address patient requirements.",
