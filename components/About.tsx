...
export default function CenteredCardAnimation(props: Partial<CardAnimationProps>) {
  ...
  const allProps: CardAnimationProps = {
    ...
    bodyText2:       props.bodyText2       ?? "At VWPL Pharma, we envision global pharmaceutical leadership through innovation, creativity, and an unwavering commitment to enhancing patient lives. Our focus on science and medicine enables us to develop superior, differentiated products that address patient requirements.",
